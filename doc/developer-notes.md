...
Endorphin Core is a multithreaded application, and deadlocks or other multithreading bugs
...
However, in open source software such as Endorphin Core, where everyone uses
...
pay attention to for reviewers of Endorphin Core code.

General Endorphin Core
----------------------
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: Endorphin Core uses tinyformat, which is type safe. Leave them out to avoid confusion
