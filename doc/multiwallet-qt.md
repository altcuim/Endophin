...
Only requiring some minor changes is endorphin.cpp.
...
Changes to endorphin.cpp
----------------------
endorphin.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
