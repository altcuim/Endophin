...
This mechanism has been integrated into Bitcore-Node-Endorphin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/endorphincoin/insight-api-endorphin#web-socket-api](https://github.com/endorphincoin/insight-api-endorphin#web-socket-api)
* API: [https://github.com/endorphincoin/insight-api-endorphin#instantsend-transactions](https://github.com/endorphincoin/insight-api-endorphin#instantsend-transactions)
...
By default, the Endorphin Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Endorphin Core daemon:
