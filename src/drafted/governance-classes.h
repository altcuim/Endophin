 ...
 *
 *   // network
 *   CEndorphinNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.endorphin.network/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CEndorphinNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
public:
    CEndorphinNetwork(UniValue objIn)
    {
...
// // can be under: EndorphinNetwork
// //   -- signature requirements : Key1(User)
// class CEndorphinNetworkVariable : public CGovernanceObject
// {
// private:
...
//     //     return (IsType() == EndorphinNetwork);
//     // }
