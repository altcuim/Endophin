...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "EndorphinNetwork") type = EndorphinNetwork;
    if(strType == "EndorphinNetworkVariable") type = EndorphinNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == EndorphinNetwork) s = "EndorphinNetwork";
    if(type == EndorphinNetworkVariable) s = "EndorphinNetworkVariable";
