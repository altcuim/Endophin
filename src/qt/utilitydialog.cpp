    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Endorphin Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Endorphin Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  endorphin-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Endorphin in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 END, 0.1 END, 1 END and 10 END -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://endorphin.network\">https://endorphin.network</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Endorphin Core is shutting down...") + "<br /><br />" +
