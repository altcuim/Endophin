    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Endorphin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Endorphin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and endorphin: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Endorphin Core"), this);
    aboutAction->setStatusTip(tr("Show information about Endorphin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Endorphin Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Endorphin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Endorphin addresses"));
    ...
    openAction->setStatusTip(tr("Open a endorphin: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Endorphin Core help message to get a list with possible Endorphin Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Endorphin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Endorphin network", "", count));
    } else {
...
{
    QString strTitle = tr("Endorphin Core"); // default title
    ...
    // Append title to "Endorphin Core - "
    if (!msgType.isEmpty())
        strTitle += " - " + msgType;
