...
//
// The Masternode Class. For managing the Endorphin process. It contains the input of the 1000 END, signature to prove
...
public:
    ...
    /// Is the input associated with collateral public key? (and there is 1000 END - checking if valid masternode)
