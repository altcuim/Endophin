...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Endorphin Core endorphin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  endorphin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded endorphin transaction") + "\n" +
              "  endorphin-tx [options] -create [commands]   " + _("Create hex-encoded endorphin transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded endorphin transaction
