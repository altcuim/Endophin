...
2. run endorphind with -printalert or -sendalert like this:
   /path/to/endorphind -printalert
...
void ThreadSendAlert(CConnman& connman)
{
    ...
    alert.strComment    = "";
    alert.strStatusBar  = "URGENT: Upgrade required: see https://endorphin.network";

    // Set specific client version/versions here. If setSubVer is empty, no filtering on subver is done:
    // alert.setSubVer.insert(std::string("/Endorphin Core:0.12.0.58/"));
