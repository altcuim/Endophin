...
#define BOOST_TEST_MODULE Endorphin Test Suite

#include "test_endorphin.h"
...
#endif
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_endorphin_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
